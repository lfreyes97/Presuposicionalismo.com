  ...
  <footer class="bg-base-100">
    <div class="">
      <div class="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
        <figure class="justify-center shadow-sm p-8 rounded-2xl">
          <blockquote cite="https://www.huxley.net/bnw/four.html">
            <p class="mx-auto mt-6 text-center text-sm leading-relaxed">
          ...
          <figcaption class="flex justify-center pt-4 text-base">
            —San Pablo, <cite> 1 Corintios 10:3-5 <b>[RVR 1960]</b></cite>
          </figcaption>
        </figure>
      </div>
        ...
        <div class="mx-auto max-w-7xl px-14 py-10 sm:p-6 lg:pb-8">
          <div class="items-center justify-center gap-8 md:flex md:bg-base-200  px-14 rounded-2xl bg-transparent-70 backdrop-blur-lg">
            <div class="m-2 p-2 bg-slate-50 flex grow items-center justify-center  md:justify-start">
              <a href="/" aria-label="logo" class="space-x-2 md:flex md:items-center">
                <svg class="" viewBox="0 0 628 153" width="150" height="37" stroke-width="2" stroke="none"
                  ...
                  <path
                    d="m338.4 15.9l-3.8 45.4-3.8-45.4c-0.1-1.9 1.4-3.5 3.5-3.6 2.1-0.2 3.9 1.2 4.1 3.1q0 0.2 0 0.5z" />
            ...
            <div class="m-2 flex flex-0 items-center justify-center p-2">
              <nav class="flex justify-end">
                <ul class="flex justify-end gap-4 lg:gap-4">
                  <li>
            ...
            <div
              class="m-2 flex grow-0 items-start justify-center p-2 md:bg-base-200 bg-opacity-70 backdrop-blur rounded-xl">
              <ul class="flex gap-2 md:justify-end">
                <li>
